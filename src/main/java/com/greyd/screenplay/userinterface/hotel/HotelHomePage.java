...
public class HotelHomePage {
    ...
    public static final Target FECHA_SALIDA_FIELD = Target.the("date out").located(By.xpath("//div [@data-month='"+date.getAnio()+"-0"+date.getMes()+"']//div[@class='sbox5-monthgrid-datenumber-number' and contains(text(), '"+date.getDiaRegreso()+"')]"));
